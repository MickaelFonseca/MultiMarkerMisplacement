...
#    logging.info("=============Calibration=============")
    ...
    btkTools.smartWriter(finalAcqStatic, str(DATA_PATH+finalSettings["Calibration"]["StaticTrial"][:-4])+'.C3D')#+"-pyCGM2modelled.c3d"
...
#    logging.info("=============Fitting=============")
    for trial in manager.dynamicTrials:
        ...
        btkTools.smartWriter(acqGait, str(DATA_PATH+reconstructFilenameLabelled[:-4])+'.C3D')#+"-pyCGM2modelled.c3d"
